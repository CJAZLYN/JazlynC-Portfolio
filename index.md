...
--------
<style>
/* FORCE ABSOLUTE DARK CYBERSECURITY BACKGROUND */
...
/* GLOWING CYBERSECURITY NAME FONT EFFECT */
header h1 a, h1#site-title {
  color: #39ff14 !important;
  text-shadow: 0 0 10px rgba(57, 255, 20, 0.7), 0 0 20px rgba(57, 255, 20, 0.5) !important;
...
li, p, div, span:not(.project-role) {
  color: #39ff14 !important; 
}
...
/* CLICKABLE CYBER LIVE PROJECT BUTTONS */
.live-btn {
